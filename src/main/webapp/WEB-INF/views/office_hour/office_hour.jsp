...
<script
	src="${pageContext.request.contextPath }/resources/JS/officehour/officehr.js" charset="utf-8"></script>
<script
		...
		<div class="header">
			<form action="" class="search-content datepicker-content">
				<div class="search">
					...
					</select> <input type="text" id="search-input" name="searchInput" class="form-control">
				</div>
