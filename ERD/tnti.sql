...
SELECT * FROM NOTICE ;
SELECT * FROM HOLIDAY WHERE EMP_UID=4;

SELECT count(*) FROM EMPLOYEES WHERE EMP_ID = 'sup' AND EMP_PW = '123';
UPDATE EMPLOYEES SET EMP_PW ='1234' WHERE EMP_ID = 'sup' AND EMP_PW = '123';
